...
class ProductServiceTest {
    ...
    public void findByIdIn() {
        ...
        verifyData(productList, productIdAndProduct, Product::getPrice);
    ...
    public void getProductById() {
        ...
        Assertions.assertEquals(product.getPrice(),productDetailVo.getPrice());
    ...
    public void batchUpdateByPrimaryKeys() {
        int row = productService.batchUpdateByPrimaryKeys(Arrays.asList(
                buildProduct(null, 0, "商品1", "子标题1", "主图片1", "副图片1", "商品详情1", BigDecimal.valueOf(222), 444),
                buildProduct(null, 0, "商品2", "子标题2", "主图片2", "副图片2", "商品详情2", BigDecimal.valueOf(333), 555)
        ));
